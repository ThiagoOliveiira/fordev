...
void main() {
  ...
  test('Should emit email error if valdiation fails', () {
  ...
  test('Should emit password error if valdiation fails', () {
    mockValidation(value: 'error');
  ...
  test('Should emit password error if valdiation fails', () async {
    sut.emailError.listen(expectAsync1((error) => expect(error, null)));
    sut.passwordError.listen(expectAsync1((error) => expect(error, null)));
